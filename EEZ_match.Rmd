...
H_UCI <- 
  ...
  right_join(pct_fed_merge, by = c("year", "spp")) %>%
    mutate(fed_P = ifelse(location == "boat", H_P * pct_P, 0),
           state_P = ifelse(location == "boat", H_P * (1 - pct_P) + H_KL, H_P + H_KL),
           fed_UCI = ifelse(location == "boat", H_P * pct_UCI, 0),
